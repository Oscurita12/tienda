let personajes=[
    ...
    {fotop: 'img/Dipper-Pines.jpg', descripcionp: "Dipper es un chico muy inteligente, organizado y crítico con lo que hace. Le interesa y disfruta mucho de resolver los misterios del pueblo, analizar y hacer teorías, aunque también puede llegar a ponerse paranoico respecto a los eventos paranormales del pueblo."},
    {fotop: 'img/Mabel-pines.jpg', descripcionp: "Mabel es reconocida por ser alegre, optimista, divertida, relajada y soñadora. Siempre disfruta cualquier momento con sus amigos y está dispuesta a realizar cualquier actividad divertida o extrema con tal de divertirse."},
    {fotop: 'img/StanleyPines.jpg', descripcionp: "Es un hombre rudo, avaro y un rudo vendedor que consiguió crear una tienda en un pueblo con varios clientes incoherentes para vender sus artilugios sin valor."},
    {fotop: 'img/Ford_Pines.jpg', descripcionp: "Ford es considerado un hombre muy serio y centrado. Cuando era joven, al ser considerado como un 'fenómeno' por sus seis dedos en cada mano, otros niños se burlaban de él, hasta que aprendió a ignorarlos."},
    ...
    {fotop: 'img/El_Viejo_McGucket.jpg', descripcionp:"Su personalidad es algo demente y loca, pero a lo largo de la serie ha demostrado ser más inteligente de lo que aparenta. Es conocido como el 'loco del pueblo' por su actitud excéntrica."},
    {fotop: 'img/Bill_Clave.jpg', descripcionp: "Bill es un demonio del sueño que para él todo es divertido y no tiene remordimiento alguno al matar o destruir cosas. Es extraño y da la sensación de que está loco."}
]
